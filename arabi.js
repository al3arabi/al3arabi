function slideshow(e) { document.write('<div id="Slider"><div class="Slider"><ul>');
	for (var i = 0; i < numpost; i++) {
		try {
			var f = e.feed.entry[i];
			var g = f.title.$t;
			var h = f.author[0].name.$t;
			var j;
			...
			try {
				if ("content" in f) {
					var l = f.media$thumbnail.url;
					var m = l.substring(l.indexOf("http://img.youtube.com/vi/") + 26, l.indexOf("/default.jpg")) }
				if (l.indexOf("http://img.youtube.com/vi/") >= 0) { thumburl = 'http://i2.ytimg.com/vi/' + m + '/hqdefault.jpg' } else { thumburl = f.gform_foot.url } } catch (error) { s = f.content.$t;
				a = s.indexOf("<img");
				b = s.indexOf("src=\"", a);
				c = s.indexOf("\"", b + 5);
				d = s.substr(b + 5, c - b - 5);
				if ((a != -1) && (b != -1) && (c != -1) && (d != "")) { thumburl = d } else thumburl = 'http://2.bp.blogspot.com/-ex3V86fj4dQ/UrCQQa4cLsI/AAAAAAAAFdA/j2FCTmGOrog/s1600/no-thumbnail.png' }
			var n = f.published.$t;
			var o = n.substring(0, 4);
			var p = n.substring(5, 7);
			var q = n.substring(8, 10);
			var r = [""];
			document.write('<li><div class="slide"><a href="' + j + '"></a><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"/><span>' + g + '<span/></div></li>') } catch (error) {} }
	document.write('</ul></div><div class="Slider_pager"></div></div>') }
			...
			if (e.feed.entry.length != 0) {
				...
				for (var k = 0; k < f.link.length; k++) {
					if (f.link[k].rel == 'replies' && f.link[k].type == 'text/html') {
						var j = f.link[k].title;
						var l = f.link[k].href }
					if (f.link[k].rel == 'alternate') { h = f.link[k].href;
						break } }
				try {
					if ("content" in f) {
						var m = f.media$thumbnail.url;
						var n = m.substring(m.indexOf("http://img.youtube.com/vi/") + 26, m.indexOf("/default.jpg")) }
					if (m.indexOf("http://img.youtube.com/vi/") >= 0) { thumburl = 'http://i2.ytimg.com/vi/' + n + '/hqdefault.jpg' } else { thumburl = f.gform_foot.url } } catch (error) { s = f.content.$t;
					a = s.indexOf("<img");
					b = s.indexOf("src=\"", a);
					c = s.indexOf("\"", b + 5);
					d = s.substr(b + 5, c - b - 5);
				...
				var t = [""];
				if (i == 0) { document.write('<div class="First"><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></div>') } else {
					if (numpost <= e.feed.entry.length) {
						if (numpost - 1 == 1) { document.write('<ul class="Post_List"><li><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></li></ul>') } else if (i == numpost - 1) { document.write('<li><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></h3></li></ul>') } else if (i == 1) { document.write('<ul class="Post_List"><li><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></li>') } else { document.write('<li><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></h3></li>') } } else if (numpost > e.feed.entry.length) {
						if (e.feed.entry.length - 1 == 1) { document.write('<ul class="Post_List"><li><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></li></ul>') } else if (i == e.feed.entry.length - 1) { document.write('<li><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></li></ul>') } else if (i == 1) { document.write('<ul class="Post_List"><li><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></li>') } else { document.write('<li><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></li>') } } } } } catch (err) {} } }

function load() { document.write('<scr' + 'ipt src="/feeds/posts/default/-/' + Label + '?published&alt=json-in-script&callback=' + Type + '\"></scr' + 'ipt>') }

function loadd() { document.write('<scr' + 'ipt src="/feeds/posts/default/?published&alt=json-in-script&callback=' + Type + '\"></scr' + 'ipt>') }

function list(e) { document.write('<ul class="Post_List">');
	for (var i = 0; i < numpost; i++) {
		try {
			var f = e.feed.entry[i];
			var g = f.title.$t;
			...
			try {
				...
				d = s.substr(b + 5, c - b - 5);
				if ((a != -1) && (b != -1) && (c != -1) && (d != "")) { thumburl = d } else thumburl = 'http://2.bp.blogspot.com/-ex3V86fj4dQ/UrCQQa4cLsI/AAAAAAAAFdA/j2FCTmGOrog/s1600/no-thumbnail.png' }
			document.write('<li><div class="img"><a href="' + h + '"><img class="postimg" style="background:url(' + thumburl + ') no-repeat center center;background-size:cover"></a></div><a href="' + h + '">' + g + '</a></li>') } catch (error) {} }
	document.write('</ul>') }
$(document).ready(function() {
	function Play_Slider() { $('.Slider ul').carouFredSel({ pagination: ".Slider_pager", items: 1, align: 'right', direction: "right", auto: { play: true, } }) }
	$("#Wapper #Wapper_Content #Container #Slider").mCustomScrollbar({ theme: "dark-thick", autoDraggerLength: false, mouseWheel: false, });
	if ($(document).width() > 1000) { Play_Slider() } });
$(document).ready(function() { $("ul.tab_content").hide();
	$("ul.tab_buttons li:first").addClass("active").show();
	$("ul.tab_content:first").show();
	$("ul.tab_buttons li").click(function() { $("ul.tab_buttons li").removeClass("active");
		$(this).addClass("active");
		$("ul.tab_content").slideUp(1000);
		var a = $(this).find("a").attr("data-id");
		$(a).slideDown(1000);
		return false }) });
(function($) {
	if ($.fn.carouFredSel) return;
	$.fn.carouFredSel = function(y, z) {
		if (this.length == 0) { debug(true, 'No element found for "' + this.selector + '".');
			return this }
		var A = this,
			$tt0 = this[0];
		if (A.data('cfs_isCarousel')) {
			var B = A.triggerHandler('_cfs_currentPosition');
			A.trigger('_cfs_destroy', true) } else {
			var B = false }
		A._cfs_init = function(o, b, c) { o = go_getObject($tt0, o);
			if (o.debug) { conf.debug = o.debug;
				debug(conf, 'The "debug" option should be moved to the second configuration-object.') }
			if (typeof o.items == 'number') o.items = { 'visible': o.items };
			else if (o.items == 'variable') o.items = { 'visible': o.items, 'width': o.items, 'height': o.items };
			if (typeof o.items != 'object') o.items = {};
			if (b) opts_orig = $.extend(true, {}, $.fn.carouFredSel.defaults, o);
			opts = $.extend(true, {}, $.fn.carouFredSel.defaults, o);
			if (typeof opts.items.visibleConf != 'object') opts.items.visibleConf = {};
			if (opts.items.start == 0 && typeof c == 'number') { opts.items.start = c }
			...
			opts.d = {};
			for (var d = 0; d < g; d++) { opts.d[f[0][d]] = f[dx][d] }
			var h = A.children();
			switch (typeof opts.items.visible) {
				case 'object':
					...
					break;
				case 'string':
					if (opts.items.visible == 'variable') { opts.items.visibleConf.variable = true } else { opts.items.visibleConf.adjust = opts.items.visible }
					opts.items.visible = false;
					break;
				case 'function':
			...
			if (ms_isPercentage(opts[opts.d['width']]) && !opts.responsive) { opts[opts.d['width']] = ms_getPercentage(ms_getTrueInnerSize($wrp.parent(), opts, 'innerWidth'), opts[opts.d['width']]);
				C.upDateOnWindowResize = true }
			if (opts[opts.d['height']] == 'auto') { opts[opts.d['height']] = ms_getTrueLargestSize(h, opts, 'outerHeight') }
			if (!opts.items[opts.d['width']]) {
				if (opts.responsive) { debug(true, 'Set a ' + opts.d['width'] + ' for the items!');
					opts.items[opts.d['width']] = ms_getTrueLargestSize(h, opts, 'outerWidth') } else { opts.items[opts.d['width']] = (ms_hasVariableSizes(h, opts, 'outerWidth')) ? 'variable' : h[opts.d['outerWidth']](true) } }
			...
			if (!opts.items.visible && !opts.responsive) {
				if (opts.items[opts.d['width']] == 'variable') { opts.items.visibleConf.variable = true }
				if (!opts.items.visibleConf.variable) {
					if (typeof opts[opts.d['width']] == 'number') { opts.items.visible = Math.floor(opts[opts.d['width']] / opts.items[opts.d['width']]) } else {
					...
					if (opts.items.visible == 'Infinity' || opts.items.visible < 1) { debug(true, 'Not a valid number of visible items: Set to "variable".');
						opts.items.visibleConf.variable = true } } }
			if (!opts[opts.d['width']]) { opts[opts.d['width']] = 'variable';
				if (!opts.responsive && opts.items.filter == '*' && !opts.items.visibleConf.variable && opts.items[opts.d['width']] != 'variable') { opts[opts.d['width']] = opts.items.visible * opts.items[opts.d['width']];
					opts.align = false } }
			if (opts.items.visibleConf.variable) { opts.maxDimention = (opts[opts.d['width']] == 'variable') ? ms_getTrueInnerSize($wrp.parent(), opts, 'innerWidth') : opts[opts.d['width']];
				if (opts.align === false) { opts[opts.d['width']] = 'variable' }
				opts.items.visible = gn_getVisibleItemsNext(h, opts, 0) } else if (opts.items.filter != '*') { opts.items.visibleConf.org = opts.items.visible;
			...
			if (opts.responsive) {
				...
				if (typeof opts[opts.d['width']] == 'number' && k < opts[opts.d['width']]) { k = opts[opts.d['width']] }
				if (j) $wrp.show();
				var m = cf_getItemAdjustMinMax(Math.ceil(k / opts.items[opts.d['width']]), opts.items.visibleConf);
				if (m > h.length) { m = h.length }
				...
				h.each(function() {
					...
					a[opts.d['width']](nw);
					if (secp) { a[opts.d['height']](ms_getPercentage(nw, seco)) } });
				opts.items.visible = m;
				opts.items[opts.d['width']] = n;
				opts[opts.d['width']] = m * n } else { opts.padding = cf_getPadding(opts.padding);
			...
			if (conf.debug) { debug(conf, 'Carousel width: ' + opts.width);
		...
		A._cfs_build = function() { A.data('cfs_isCarousel', true);
			var a = { 'textAlign': A.css('textAlign'), 'float': A.css('float'), 'position': A.css('position'), 'top': A.css('top'), 'right': A.css('right'), 'bottom': A.css('bottom'), 'left': A.css('left'), 'width': A.css('width'), 'height': A.css('height'), 'marginTop': A.css('marginTop'), 'marginRight': A.css('marginRight'), 'marginBottom': A.css('marginBottom'), 'marginLeft': A.css('marginLeft') };
			switch (a.position) {
				case 'absolute':
					var b = 'absolute';
					break;
			...
			A.data('cfs_origCss', a).css({ 'textAlign': 'left', 'float': 'none', 'position': 'absolute', 'top': 0, 'left': 0, 'marginTop': 0, 'marginRight': 0, 'marginBottom': 0, 'marginLeft': 0 });
			if (opts.usePadding) { A.children().each(function() {
					var m = parseInt($(this).css(opts.d['marginRight']));
					if (isNaN(m)) m = 0;
					$(this).data('cfs_origCssMargin', m) }) } };
		A._cfs_bind_events = function() { A._cfs_unbind_events();
			A.bind(cf_e('stop', conf), function(e, a) { e.stopPropagation();
				if (!C.isStopped) {
					if (opts.auto.button) { opts.auto.button.addClass(cf_c('stopped', conf)) } }
				C.isStopped = true;
				if (opts.auto.play) { opts.auto.play = false;
					A.trigger(cf_e('pause', conf), a) }
				return true });
			A.bind(cf_e('finish', conf), function(e) { e.stopPropagation();
				if (C.isScrolling) { sc_stopScroll(scrl) }
				return true });
			A.bind(cf_e('pause', conf), function(e, a, b) { e.stopPropagation();
				tmrs = sc_clearTimers(tmrs);
				if (a && C.isScrolling) { scrl.isStopped = true;
				...
				return true });
			A.bind(cf_e('play', conf), function(e, b, c, d) { e.stopPropagation();
				tmrs = sc_clearTimers(tmrs);
				var v = [b, c, d],
				...
				if (d) { C.isStopped = false;
					opts.auto.play = true }
				if (!opts.auto.play) { e.stopImmediatePropagation();
					return debug(conf, 'Carousel stopped: Not scrolling.') }
				if (C.isPaused) {
					if (opts.auto.button) { opts.auto.button.removeClass(cf_c('stopped', conf));
				...
				tmrs.auto = setTimeout(function() {
					if (opts.auto.onPauseEnd) { opts.auto.onPauseEnd.call($tt0, perc, dur2) }
					if (C.isScrolling) { A.trigger(cf_e('play', conf), b) } else { A.trigger(cf_e(b, conf), opts.auto) } }, dur2);
				if (opts.auto.onPauseStart) { opts.auto.onPauseStart.call($tt0, perc, dur2) }
				return true });
			A.bind(cf_e('resume', conf), function(e) { e.stopPropagation();
				if (scrl.isStopped) { scrl.isStopped = false;
					C.isPaused = false;
					C.isScrolling = true;
					scrl.startTime = getTime();
					sc_startScroll(scrl) } else { A.trigger(cf_e('play', conf)) }
				return true });
			A.bind(cf_e('prev', conf) + ' ' + cf_e('next', conf), function(e, b, f, g) { e.stopPropagation();
				if (C.isStopped || A.is(':hidden')) { e.stopImmediatePropagation();
					return debug(conf, 'Carousel stopped or hidden: Not scrolling.') }
				if (opts.items.minimum >= itms.total) { e.stopImmediatePropagation();
				...
				if (typeof f != 'number') {
					if (opts.items.filter != '*') { f = 'visible' } else {
						var i = [f, b.items, opts[h].items];
						for (var a = 0, l = i.length; a < l; a++) {
							if (typeof i[a] == 'number' || i[a] == 'page' || i[a] == 'visible') { f = i[a];
								break } } }
					switch (f) {
						case 'page':
							...
							break;
						case 'visible':
							if (!opts.items.visibleConf.variable && opts.items.filter == '*') { f = opts.items.visible }
							break } }
				if (scrl.isStopped) { A.trigger(cf_e('resume', conf));
				...
				if (b.conditions && !b.conditions.call($tt0)) { e.stopImmediatePropagation();
				...
				return true });
			A.bind(cf_e('_cfs_slide_prev', conf, false), function(e, f, g) { e.stopPropagation();
				var h = A.children();
				if (!opts.circular) {
					if (itms.first == 0) {
						if (opts.infinite) { A.trigger(cf_e('next', conf), itms.total - 1) }
						return e.stopImmediatePropagation() } }
				if (opts.usePadding) sz_resetMargin(h, opts);
				if (typeof g != 'number') {
					if (opts.items.visibleConf.variable) { g = gn_getVisibleItemsPrev(h, opts, itms.total - 1) } else if (opts.items.filter != '*') {
						var i = (typeof f.items == 'number') ? f.items : gn_getVisibleOrg(A, opts);
						g = gn_getScrollItemsPrevFilter(h, opts, itms.total - 1, i) } else { g = opts.items.visible }
					g = cf_getAdjust(g, opts, f.items, $tt0) }
				if (!opts.circular) {
					if (itms.total - g < itms.first) { g = itms.total - itms.first } }
				opts.items.visibleConf.old = opts.items.visible;
				if (opts.items.visibleConf.variable) {
					var j = gn_getVisibleItemsNext(h, opts, itms.total - g);
					if (opts.items.visible + g <= j && g < itms.total) { g++;
						j = gn_getVisibleItemsNext(h, opts, itms.total - g) }
					opts.items.visible = cf_getItemsAdjust(j, opts, opts.items.visibleConf.adjust, $tt0) } else if (opts.items.filter != '*') {
				...
				if (g == 0) { e.stopImmediatePropagation();
				...
				if (f.fx == 'directscroll' && opts.items.visible < g) {
					...
					opts.items[opts.d['width']] = 'variable' } else {
					var m = false }
				var n = ms_getTotalSize(h.slice(0, g), opts, 'width'),
					w_siz = cf_mapWrapperSizes(ms_getSizes(c_new, opts, true), opts, !opts.usePadding);
				if (m) opts.items[opts.d['width']] = orgW;
				if (opts.usePadding) { sz_resetMargin(h, opts, true);
					if (pR >= 0) { sz_resetMargin(l_old, opts, opts.padding[opts.d[1]]) }
				...
				if (opts[opts.d['width']] == 'variable' || opts[opts.d['height']] == 'variable') { scrl.anims.push([$wrp, w_siz]) }
				if (opts.usePadding) {
				...
				switch (f.fx) {
					...
					case 'crossfade':
						v.css({ 'opacity': 0 });
						scrl.pre.anims.push([A, { 'width': '+=0' }, function() { v.remove() }]);
				...
				var w = function() {
					...
					var d = function() {
						...
						if (queu.length) { A.trigger(cf_e(queu[0][0], conf), queu[0][1]);
							queu.shift() }
				...
				return true });
			A.bind(cf_e('_cfs_slide_next', conf, false), function(e, f, g) { e.stopPropagation();
				var h = A.children();
				if (!opts.circular) {
					if (itms.first == opts.items.visible) {
						if (opts.infinite) { A.trigger(cf_e('prev', conf), itms.total - 1) }
						return e.stopImmediatePropagation() } }
				if (opts.usePadding) sz_resetMargin(h, opts);
				if (typeof g != 'number') {
					if (opts.items.filter != '*') {
						var i = (typeof f.items == 'number') ? f.items : gn_getVisibleOrg(A, opts);
						g = gn_getScrollItemsNextFilter(h, opts, 0, i) } else { g = opts.items.visible }
					g = cf_getAdjust(g, opts, f.items, $tt0) }
				var j = (itms.first == 0) ? itms.total : itms.first;
				if (!opts.circular) {
					if (opts.items.visibleConf.variable) {
						var k = gn_getVisibleItemsNext(h, opts, g),
							i = gn_getVisibleItemsPrev(h, opts, j - 1) } else {
				...
				if (opts.items.visibleConf.variable) {
					...
					while (opts.items.visible - g >= k && g < itms.total) { g++;
						k = gn_getVisibleItemsNextTestCircular(h, opts, g, j) }
					opts.items.visible = cf_getItemsAdjust(k, opts, opts.items.visibleConf.adjust, $tt0) } else if (opts.items.filter != '*') {
				...
				if (opts.usePadding) {
					...
					if (pR >= 0) { q += opts.padding[opts.d[1]] }
					...
					if (l >= 0) { s += opts.padding[opts.d[3]] }
					var t = {};
					t[opts.d['marginRight']] = s;
					scrl.anims.push([l_cur, t]) }
				o[opts.d['left']] = -n;
				if (l < 0) { o[opts.d['left']] += l }
				var u = [c_old, c_new, w_siz, a_dur];
				if (f.onBefore) f.onBefore.apply($tt0, u);
				clbk.onBefore = sc_callCallbacks(clbk.onBefore, $tt0, u);
				switch (f.fx) {
				...
				var w = function() {
					...
					if (b > 0) { c_new = gi_getCurrentItems(h, opts) }
					if (m) { m.each(function() {
							var a = $(this);
							if (!a.data('isHidden')) a.show() }) }
					if (opts.usePadding) {
				...
				A.trigger(cf_e('updatePageStatus', conf), [false, w_siz]);
				return true });
			A.bind(cf_e('slideTo', conf), function(e, b, c, d, f, g, h) { e.stopPropagation();
				var v = [b, c, d, f, g, h],
				...
				return true });
			A.bind(cf_e('prevPage', conf), function(e, a, b) { e.stopPropagation();
				var c = A.triggerHandler(cf_e('currentPage', conf));
				return A.triggerHandler(cf_e('slideToPage', conf), [c - 1, a, 'prev', b]) });
			A.bind(cf_e('nextPage', conf), function(e, a, b) { e.stopPropagation();
				var c = A.triggerHandler(cf_e('currentPage', conf));
				return A.triggerHandler(cf_e('slideToPage', conf), [c + 1, a, 'next', b]) });
			A.bind(cf_e('slideToPage', conf), function(e, a, b, c, d) { e.stopPropagation();
			...
			A.bind(cf_e('jumpToStart', conf), function(e, s) { e.stopPropagation();
				...
				return true });
			A.bind(cf_e('synchronise', conf), function(e, s) { e.stopPropagation();
				...
				var n = A.triggerHandler(cf_e('currentPosition', conf)),
					x = true;
				for (var j = 0, l = s.length; j < l; j++) {
					if (!s[j][0].triggerHandler(cf_e('slideTo', conf), [n, s[j][3], true])) { x = false } }
				return x });
			A.bind(cf_e('queue', conf), function(e, a, b) { e.stopPropagation();
				if (typeof a == 'function') { a.call($tt0, queu) } else if (is_array(a)) { queu = a } else if (typeof a != 'undefined') { queu.push([a, b]) }
				return queu });
			A.bind(cf_e('insertItem', conf), function(e, b, c, d, f) { e.stopPropagation();
				var v = [b, c, d, f],
				...
				if (opts.usePadding) { b.each(function() {
						var m = parseInt($(this).css(opts.d['marginRight']));
						if (isNaN(m)) m = 0;
						$(this).data('cfs_origCssMargin', m) }) }
				var g = c,
				...
				if (c == 'end') {
					if (d) {
						if (itms.first == 0) { c = itms.total - 1;
							before = 'after' } else { c = itms.first;
							itms.first += b.length }
						if (c < 0) c = 0 } else { c = itms.total - 1;
						before = 'after' } } else { c = gn_getItemIndex(c, f, d, itms, A) }
				if (g != 'end' && !d) {
					if (c < itms.first) itms.first += b.length }
				if (itms.first >= itms.total) itms.first -= itms.total;
				var h = A.children().eq(c);
				if (h.length) { h[before](b) } else { A.append(b) }
				...
				return true });
			A.bind(cf_e('removeItem', conf), function(e, b, c, d) { e.stopPropagation();
				var v = [b, c, d],
				...
				var b = a[0],
					c = a[1],
					d = a[2];
				if (typeof b == 'undefined' || b == 'end') { A.children().last().remove() } else { b = gn_getItemIndex(b, d, c, itms, A);
				...
				return true });
			A.bind(cf_e('onBefore', conf) + ' ' + cf_e('onAfter', conf), function(e, a) { e.stopPropagation();
				var b = e.type.substr(conf.events.prefix.length);
				if (is_array(a)) clbk[b] = a;
				if (typeof a == 'function') clbk[b].push(a);
				return clbk[b] });
			A.bind(cf_e('_cfs_currentPosition', conf, false), function(e, a) { e.stopPropagation();
				return A.triggerHandler(cf_e('currentPosition', conf), a) });
			A.bind(cf_e('currentPosition', conf), function(e, a) { e.stopPropagation();
				if (itms.first == 0) var b = 0;
				else var b = itms.total - itms.first;
				if (typeof a == 'function') a.call($tt0, b);
				return b });
			A.bind(cf_e('currentPage', conf), function(e, a) { e.stopPropagation();
				...
				return d });
			A.bind(cf_e('currentVisible', conf), function(e, a) { e.stopPropagation();
				$i = gi_getCurrentItems(A.children(), opts);
				if (typeof a == 'function') a.call($tt0, $i);
				return $i });
			A.bind(cf_e('slice', conf), function(e, f, l, b) { e.stopPropagation();
				var v = [f, l, b],
				...
				var c = A.children();
				if (l > f) {
					var d = c.slice(f, l) } else {
					var d = c.slice(f, itms.total).get().concat(c.slice(0, l).get()) }
				if (typeof b == 'function') b.call($tt0, d);
				return d });
			A.bind(cf_e('isPaused', conf) + ' ' + cf_e('isStopped', conf) + ' ' + cf_e('isScrolling', conf), function(e, a) { e.stopPropagation();
				var b = e.type.substr(conf.events.prefix.length);
				if (typeof a == 'function') a.call($tt0, C[b]);
				return C[b] });
			A.bind(cf_e('_cfs_configuration', conf, false), function(e, a, b, c) { e.stopPropagation();
				return A.triggerHandler(cf_e('configuration', conf), [a, b, c]) });
			A.bind(cf_e('configuration', conf), function(e, a, b, c) { e.stopPropagation();
				var d = false;
				if (typeof a == 'function') { a.call($tt0, opts) } else if (typeof a == 'object') { opts_orig = $.extend(true, {}, opts_orig, a);
					if (b !== false) d = true;
					else opts = $.extend(true, {}, opts, a) } else if (typeof a != 'undefined') {
					if (typeof b == 'function') {
						var f = eval('opts.' + a);
						if (typeof f == 'undefined') f = '';
						b.call($tt0, f) } else if (typeof b != 'undefined') {
						if (typeof c !== 'boolean') c = true;
						eval('opts_orig.' + a + ' = b');
						if (c !== false) d = true;
						else eval('opts.' + a + ' = b') } else {
						return eval('opts.' + a) } }
				if (d) { sz_resetMargin(A.children(), opts);
					A._cfs_init(opts_orig);
					A._cfs_bind_buttons();
					var g = sz_setSizes(A, opts, false);
					A.trigger(cf_e('updatePageStatus', conf), [true, g]) }
				return opts });
			A.bind(cf_e('linkAnchors', conf), function(e, a, b) { e.stopPropagation();
				...
				a.find(b).each(function() {
					var h = this.hash || '';
					if (h.length > 0 && A.children().index($(h)) != -1) { $(this).unbind('click').click(function(e) { e.preventDefault();
							A.trigger(cf_e('slideTo', conf), h) }) } });
				return true });
			A.bind(cf_e('updatePageStatus', conf), function(e, b, c) { e.stopPropagation();
				...
				opts.pagination.container.each(function() { $(this).children().removeClass(cf_c('selected', conf)).eq(A.triggerHandler(cf_e('currentPage', conf))).addClass(cf_c('selected', conf)) });
				return true });
			A.bind(cf_e('updateSizes', conf), function(e) {
				...
				if (!opts.circular && itms.first != 0 && vI > itms.first) {
					if (opts.items.visibleConf.variable) {
						var b = gn_getVisibleItemsPrev(a, opts, itms.first) - itms.first } else if (opts.items.filter != '*') {
						var b = gn_getVisibleItemsPrevFilter(a, opts, itms.first) - itms.first } else { b = opts.items.visible - itms.first }
					debug(conf, 'Preventing non-circular: sliding ' + b + ' items backward.');
					A.trigger('prev', b) }
				opts.items.visible = cf_getItemsAdjust(vI, opts, opts.items.visibleConf.adjust, $tt0);
				return sz_setSizes(A, opts) });
			A.bind(cf_e('_cfs_destroy', conf, false), function(e, a) { e.stopPropagation();
				A.trigger(cf_e('destroy', conf), a);
				return true });
			A.bind(cf_e('destroy', conf), function(e, a) { e.stopPropagation();
				tmrs = sc_clearTimers(tmrs);
				A.data('cfs_isCarousel', false);
				A.trigger(cf_e('finish', conf));
				if (a) { A.trigger(cf_e('jumpToStart', conf)) }
				...
				$wrp.replaceWith(A);
				return true }) };
		A._cfs_unbind_events = function() { A.unbind(cf_e('', conf));
			A.unbind(cf_e('', conf, false)) };
		A._cfs_bind_buttons = function() { A._cfs_unbind_buttons();
			nv_showNavi(opts, itms.total, conf);
			nv_enableNavi(opts, itms.first, conf);
			if (opts.auto.pauseOnHover) {
				var c = bt_pauseOnHoverConfig(opts.auto.pauseOnHover);
				$wrp.bind(cf_e('mouseenter', conf, false), function() { A.trigger(cf_e('pause', conf), c) }).bind(cf_e('mouseleave', conf, false), function() { A.trigger(cf_e('resume', conf)) }) }
			if (opts.auto.button) { opts.auto.button.bind(cf_e(opts.auto.event, conf, false), function(e) { e.preventDefault();
					var a = false,
						c = null;
					if (C.isPaused) { a = 'play' } else if (opts.auto.pauseOnEvent) { a = 'pause';
			...
			if (opts.prev.button) { opts.prev.button.bind(cf_e(opts.prev.event, conf, false), function(e) { e.preventDefault();
				...
				if (opts.prev.pauseOnHover) {
					...
					opts.prev.button.bind(cf_e('mouseenter', conf, false), function() { A.trigger(cf_e('pause', conf), c) }).bind(cf_e('mouseleave', conf, false), function() { A.trigger(cf_e('resume', conf)) }) } }
			if (opts.next.button) { opts.next.button.bind(cf_e(opts.next.event, conf, false), function(e) { e.preventDefault();
				...
				if (opts.next.pauseOnHover) {
					...
					opts.next.button.bind(cf_e('mouseenter', conf, false), function() { A.trigger(cf_e('pause', conf), c) }).bind(cf_e('mouseleave', conf, false), function() { A.trigger(cf_e('resume', conf)) }) } }
			if ($.fn.mousewheel) {
				if (opts.prev.mousewheel) {
					if (!C.mousewheelPrev) { C.mousewheelPrev = true;
						$wrp.mousewheel(function(e, a) {
							if (a > 0) { e.preventDefault();
								var b = bt_mousesheelNumber(opts.prev.mousewheel);
								A.trigger(cf_e('prev', conf), b) } }) } }
				if (opts.next.mousewheel) {
					if (!C.mousewheelNext) { C.mousewheelNext = true;
						$wrp.mousewheel(function(e, a) {
							if (a < 0) { e.preventDefault();
								var b = bt_mousesheelNumber(opts.next.mousewheel);
								A.trigger(cf_e('next', conf), b) } }) } } }
			if ($.fn.touchwipe) {
				var d = (opts.prev.wipe) ? function() { A.trigger(cf_e('prev', conf)) } : null,
					wN = (opts.next.wipe) ? function() { A.trigger(cf_e('next', conf)) } : null;
				if (wN || wN) {
					if (!C.touchwipe) { C.touchwipe = true;
			...
			if (opts.pagination.container) {
				if (opts.pagination.pauseOnHover) {
					...
					opts.pagination.container.bind(cf_e('mouseenter', conf, false), function() { A.trigger(cf_e('pause', conf), c) }).bind(cf_e('mouseleave', conf, false), function() { A.trigger(cf_e('resume', conf)) }) } }
			if (opts.prev.key || opts.next.key) { $(document).bind(cf_e('keyup', conf, false, true, true), function(e) {
					var k = e.keyCode;
					if (k == opts.next.key) { e.preventDefault();
						A.trigger(cf_e('next', conf)) }
					if (k == opts.prev.key) { e.preventDefault();
						A.trigger(cf_e('prev', conf)) } }) }
			if (opts.pagination.keys) { $(document).bind(cf_e('keyup', conf, false, true, true), function(e) {
					var k = e.keyCode;
			...
			if (C.upDateOnWindowResize) { $(window).bind(cf_e('resize', conf, false, true, true), function(e) { A.trigger(cf_e('finish', conf));
					if (opts.auto.pauseOnResize && !C.isPaused) { A.trigger(cf_e('play', conf)) }
		...
		var C = { 'direction': 'next', 'isPaused': true, 'isScrolling': false, 'isStopped': false, 'mousewheelNext': false, 'mousewheelPrev': false, 'touchwipe': false },
		...
		if (is_array(opts.items.start)) {
			var D = opts.items.start } else {
			var D = [];
			if (opts.items.start != 0) { D.push(opts.items.start) } }
		var E = sz_setSizes(A, opts, false),
			itm = gi_getCurrentItems(A.children(), opts);
		if (opts.onCreate) { opts.onCreate.call($tt0, itm, E) }
	...
	function sc_startScroll(s) {
		if (typeof s.pre == 'object') { sc_startScroll(s.pre) }
	...
	function sc_callCallbacks(b, t, c) {
		if (b.length) {
			for (var a = 0, l = b.length; a < l; a++) { b[a].apply(t, c) } }
		return [] }

	function nv_showNavi(o, t, c) {
		if (t == 'show' || t == 'hide') {
			var f = t } else if (o.items.minimum >= t) { debug(c, 'Not enough items: hiding navigation (' + t + ' items, ' + o.items.minimum + ' needed).');
			var f = 'hide' } }
	...
	function go_getNaviObject(a, b, c) {
		...
		if (c == 'pagination') {
			...
			if (typeof b.items != 'number') b.items = false } else if (c == 'auto') {
			...
			if (typeof b.button == 'string') b.button = $(b.button) } else {
			if (typeof b.jquery != 'undefined') b = { 'button': b };
	...
	function gn_getItemIndex(a, b, c, d, e) {
		...
		if (typeof a == 'object') {
			...
			if (a == -1) a = 0;
			if (typeof c != 'boolean') c = false } else {
			if (typeof c != 'boolean') c = true }
		if (isNaN(a)) a = 0;
		else a = parseInt(a);
		if (isNaN(b)) b = 0;
	...
	function cf_sortParams(c, d) {
		...
		for (var a = 0, l1 = c.length; a < l1; a++) {
			for (var b = 0, l2 = d.length; b < l2; b++) {
				if (d[b].indexOf(typeof c[a]) > -1 && typeof e[b] == 'undefined') { e[b] = c[a];
					break } } }
		return e }
	...
	function cf_getAdjust(x, o, a, b) {
		var v = x;
		if (typeof a == 'function') { v = a.call(b, v) } else if (typeof a == 'string') {
			var p = a.split('+'),
				m = a.split('-');
	...
	function debug(d, m) {
		if (typeof d == 'object') {
			...
			d = d.debug } else {
			var s = '' } } })(jQuery);
(function(a) { a.fn.mCustomScrollbar = function(c) {
		if (b[c]) {
			return b[c].apply(this, Array.prototype.slice.call(arguments, 1)) } } })(jQuery);
$(document).ready(function() { $(".PopularPosts img").attr("width", "120px").attr("height", "90px").attr("src", function(t, r) {
		return r.replace("s72-c", "s120-c") }) }), $(document).ready(function() { $(".post-summary img").attr("width", "100%").attr("height", "100%").attr("src", function(t, r) {
		return r.replace("s72-c", "s210-c") }) });
$(document).ready(function() {
	var d = $(".slidernav").offset().top;
	var c = function() {
		var a = $(window).scrollTop();
		if (a > d) { $(".heeader").addClass("sticky") } else { $(".heeader").removeClass("sticky") } };
	c();
